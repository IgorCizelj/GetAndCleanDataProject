...
8. Saves the tidy dataset as [tidy_data.csv](https://github.com/IgorCizelj/GetAndCleanDataProject/blob/master/tidy_data.csv) so that it can be easily imported and viewed
