...
8. Saves the tidy dataset as [tidy_data.txt](https://github.com/IgorCizelj/GetAndCleanDataProject/blob/master/tidy_data.txt) and  [tidy_data.csv](https://github.com/IgorCizelj/GetAndCleanDataProject/blob/master/tidy_data.csv) so that it can be easily imported and viewed
